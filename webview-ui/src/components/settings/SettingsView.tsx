...
const SettingsView = forwardRef<SettingsViewRef, SettingsViewProps>(({ onDone, targetSection }, ref) => {
	...
	const handleSubmit = () => {
		if (isSettingValid) {
			...
			vscode.postMessage({ type: "ttsVoiceNative", text: ttsVoiceNative })
			vscode.postMessage({ type: "ttsVoiceGoogleCloud", text: ttsVoiceGoogleCloud })
			vscode.postMessage({ type: "ttsVoiceAzure", text: ttsVoiceAzure })
			vscode.postMessage({ type: "azureRegion", region: azureRegion })
			vscode.postMessage({ type: "azureTtsTier", tier: azureTtsTier })
